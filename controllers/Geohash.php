...
echo GeoHash::encode(117.031689, 36.65396, 0.0001);
echo " ";
echo GeoHash::encode(117.031689, 36.65396, 0.001);
echo " ";
echo GeoHash::encode(117.031689, 36.65396, 0.01);
echo " ";
echo GeoHash::encode(117.031689, 36.65396, 0.02);
echo " ";
echo GeoHash::encode(117.031689, 36.65396, 0.1);
echo " ";

var_dump(GeoHash::expand('wwe0x0euu'));
